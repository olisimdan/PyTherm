...
C1OHnC6.CPAParams(1, 30.978, 1573.71,  0.43102)    # CPA parameters, b, Gamma=a/Rb, c1
C1OHnC6.CPAParams(2, 107.89, 2640.03,  0.8313)

C1OHnC6.AssocParams(1, 11,  16.1, 2957.78)      # association parameters, 2B, ass vol, (ass eng/kB)/K

C1OHnC6.NoSpecKij(1)
C1OHnC6.SpecKij(1, 1, 2, 0.01)                    # kij for (epsilon/kB)
