...
Case.CritProps(1, 190.60, 45.99, 0.008);  # C1
Case.CritProps(2, 304.20, 73.75, 0.225);  # CO2

Case.NoSpecKij(1);
Case.SpecKij(1, 1, 2, 0.12);    # C1-CO2

Case.Setup_Thermo();

T = 180.0;
np_vl1, vl1Pxy, np_ll, llPxy, np_vl2, vl2Pxy, critpoint, nscrit, ierr = Case.PXYdiagram(T)
#print(np_vl1)
#print(vl1Pxy)
#print(np_ll)
#print(llPxy)
...
P = 1.0
np_vl1, vl1Txy, np_ll, llTxy, np_vl2, vl2Txy, critpoint, nscrit, ierr = Case.TXYdiagram(P)
#print(np_vl1)
#print(vl1Txy)
#print(np_ll)
#print(llTxy)
